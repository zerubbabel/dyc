CREATE TABLE `dyc`.`cmf_dyc_user_work` 
( 	`user_id` INT NOT NULL , 
	`work_id` INT NOT NULL , 
	PRIMARY KEY (`user_id`,`work_id`)) ENGINE = InnoDB;

CREATE TABLE `dyc`.`cmf_dyc_work` 
...
--department
CREATE TABLE `dyc`.`cmf_dyc_departments` ( `id` INT NOT NULL AUTO_INCREMENT , `dep_name` INT NOT NULL COMMENT '部门名称' , `status` BOOLEAN NOT NULL COMMENT '状态' , PRIMARY KEY (`id`)) ENGINE = InnoDB;
...
--
CREATE TABLE `dyc`.`cmf_dyc_data_tables` ( `id` INT NOT NULL AUTO_INCREMENT , `table_id` VARCHAR(50) NOT NULL , `table_name` VARCHAR(50) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;
